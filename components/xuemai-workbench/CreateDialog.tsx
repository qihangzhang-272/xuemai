    ...
    <form onSubmit={event => { event.preventDefault(); void save(); }}>
      ...
      <div className="space-y-4 bg-[#f7f8f7] p-4">
        <section className="rounded-[18px] bg-white p-4">
          <p className="mb-3 text-[13px] leading-6 text-[#5c665f]">{isStudent ? "先填姓名和科目，创建后就可以记录这节课。" : "班级用于整理共同教学内容；个人表现记在学生档案里。"}</p>
          ...
          <SelectRow label="年级（选填）" value={payload.grade} options={gradeOptions} empty="暂不填写" onChange={value => updateField("grade", value)} />
